...
{
    /// <summary>
    /// Abstract class represents an abstraction of other commmon functionality
    /// </summary>
    ...
    public abstract class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        {
            return new SqlConnection("Data Source=.;Initial Catalog=SalesDb;Integrated Security=True");
        }
